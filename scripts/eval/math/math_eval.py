...
def evaluate_dataset(llm, dataset, dataset_path, model_name, tokenizer, save_path, batch_size=8):
...
def main():
    ...
    print(f"Please use the verifier.sh to verify the final answer!")
