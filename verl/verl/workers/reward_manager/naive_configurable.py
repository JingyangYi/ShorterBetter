...
class ConfigurableRewardManager:
    """The reward manager with configurable alpha and beta parameters.
    """

    def __init__(self, tokenizer, num_examine, train_batch_size, num_generation, alpha=2.0, beta=0.001, compute_score=None) -> None:
        self.tokenizer = tokenizer
        self.num_examine = num_examine  # the number of batches of decoded responses to print to the console
        self.compute_score = compute_score or _default_compute_score
        self.train_batch_size = train_batch_size
        self.num_generation = num_generation
        self.alpha = alpha  # Configurable correctness reward weight
        self.beta = beta    # Configurable length penalty weight
    ...
    def check_correctness_and_length(self, data):
        ...
        for problem_id in unique_problem_ids:
            ...
            # Use the original strategy of choosing shortest correct response, or average if none correct
    ...
    def __call__(self, data: DataProto):
        ...
        def sb_compute_score(optimal_length, completion_length, correct_or_not, alpha, beta):
        ...
        for i in range(len(data)):
            ...
            # Use configurable alpha and beta parameters
            score = sb_compute_score(optimal_length, completion_length, correct_or_not, self.alpha, self.beta)
            ...
            if already_print_data_sources[data_source] < self.num_examine:
                ...
                print("[score]", score)
                print(f"[config] alpha={self.alpha}, beta={self.beta}")
